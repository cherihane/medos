...
const PAGES_PAR_ROLE = {
  ...
  hopital: [
    ...
    { path: "/hopital/planning",     label: "Planning gardes" },
  ],
  distributeur: [
...
const PERMISSIONS_DEFAUT = {
  ...
  hopital: {
    ...
    "Sage-femme":             ["/hopital/dashboard", "/hopital/maternite", "/hopital/patients", "/hopital/alertes", "/hopital/pediatrie", "/hopital/planning"],
