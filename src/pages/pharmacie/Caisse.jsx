...
export default function Caisse() {
  ...
  // Favoris = 8 premiers médicaments triés par stock
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 10 }}>
                {favoris.map((m) => (
                  <button key={m.id} onClick={() => addToCart(m)} style={{
                    ...
                    border: "1.5px solid #E5E7EB", borderRadius: 10, cursor: "pointer", textAlign: "center",
                  }}>
                    ...
                    <div style={{ fontSize: 12, color: "#3B82F6", fontWeight: 600 }}>
                      {(m.prix_unitaire ?? 0).toLocaleString()} FCFA
                    </div>
                  </button>
                ))}
              </div>
        ...
        <div style={{ backgroundColor: "white", borderRadius: 14, padding: "20px", boxShadow: "0 1px 4px rgba(0,0,0,0.06)", display: "flex", flexDirection: "column" }}>
          ...
          <div style={{ borderTop: "1px solid #E5E7EB", paddingTop: 16, marginTop: 8 }}>
            ...
            <button
              ...
              onClick={() => { alert(`Vente enregistrée !\nTotal : ${total.toLocaleString()} FCFA\nMode : ${paiement}`); setCart([]); }}
              style={{
