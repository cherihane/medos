...
// On derive les "crédits" depuis les commandes non encore livrées/annulées
...
export default function Credits() {
  const { data: commandes, loading, error } = useCommandes();

  // Filtrer les commandes actives (en cours de paiement)
            ...
            <div key={c.id} style={{ backgroundColor: "white", borderRadius: 16, padding: "24px", boxShadow: "0 1px 4px rgba(0,0,0,0.06)" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 16 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  <span style={{ fontSize: 13, color: "#6B7280" }}>Livraison prévue : <strong>{fmt(c.date_livraison_prevue)}</strong></span>
